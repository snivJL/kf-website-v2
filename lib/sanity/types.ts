...
// Query: *[_type == "highlights"][0] {  heading,  graySubHeading,  blueSubHeading,  items[] {    title,    problem,    solution,    shortText,    testimonial,    tagline  }}
